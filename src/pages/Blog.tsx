    ...
    <section className="relative min-h-[80vh] flex items-center justify-center px-4 md:px-6">
      ...
      <div className="relative z-10 container mx-auto text-center max-w-4xl space-y-8">
        ...
        <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto backdrop-blur-[2px]">
          Stay informed about the Delft housing market with expert analyses, buying and selling tips, neighborhood spotlights, and Van der Berg company news.
        </p>
  ...
  return (
    <section className="py-16 md:py-24 px-4 md:px-6 ">
      <div className="container mx-auto max-w-6xl">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-foreground">Latest Articles</h2>
        <div className="mb-8" />
