      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center max-w-6xl">
        <div className="space-y-6">
          ...
          <div className="prose prose-gray max-w-none text-muted-foreground space-y-4">
            <p>Deze woning aan de [Adres] biedt een unieke combinatie van comfort, stijl en een uitstekende locatie. Met [aantal] slaapkamers en [aantal] vierkante meter woonoppervlakte is er volop ruimte voor het hele gezin. De moderne keuken is voorzien van alle gemakken en de lichte woonkamer kijkt uit op de [tuin/straat].</p>
            <p>Gelegen in de gewilde wijk [Wijknaam] profiteert u van de nabijheid van scholen, winkels en openbaar vervoer. Het energielabel [label] garandeert een energiezuinige woning. Neem contact met ons op voor een persoonlijke rondleiding en ervaar zelf de charme van deze woning.</p>
          </div>
...
export default function PropertyDetailPage() {
  useEffect(() => {
    document.title = 'property-detail | Van der Berg Makelaardij'
  }, [])
