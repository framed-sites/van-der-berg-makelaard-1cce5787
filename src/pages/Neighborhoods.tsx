    ...
    <section className="relative min-h-[80vh] flex items-center justify-center px-4 md:px-6">
      ...
      <div className="relative z-10 container mx-auto text-center max-w-4xl space-y-8">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white text-balance">
          Discover Delft&#39;s Neighborhoods
        </h1>
        <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto backdrop-blur-[2px]">
          Every neighborhood in Delft has its own character, charm, and community. Explore our neighborhood guides to find the area that feels like home.
        </p>
  ...
  return (
    <section className="py-16 md:py-24 px-4 md:px-6 ">
      <div className="container mx-auto max-w-6xl">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-foreground">Our Neighborhood Guides</h2>
        <div className="mb-8" />
...
export default function NeighborhoodsPage() {
  useEffect(() => {
    document.title = 'Neighborhoods | My Website'
  }, [])
