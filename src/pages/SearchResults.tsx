      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center max-w-6xl">
        <div className="space-y-6">
          ...
          <div className="prose prose-gray max-w-none text-muted-foreground space-y-4">
            <p>We hebben de best passende woningen voor u geselecteerd op basis van uw criteria. Elk van deze woningen is zorgvuldig beoordeeld en biedt unieke mogelijkheden. Gebruik de filters aan de zijkant om uw zoekresultaten verder te specificeren en filter bijvoorbeeld op woningtype, prijsklasse of het aantal slaapkamers.</p>
            <p>Wanneer u een interessante woning ziet, klik dan op de woning voor meer details, foto&#39;s en informatie over het plannen van een bezichtiging. Ons team staat altijd klaar om al uw vragen te beantwoorden en u te begeleiden bij elke stap van het proces. Uw droomhuis wacht op u!</p>
          </div>
...
export default function SearchResultsPage() {
  useEffect(() => {
    document.title = 'search-results | Van der Berg Makelaardij'
  }, [])
