      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center max-w-6xl">
        <div className="space-y-6">
          ...
          <div className="prose prose-gray max-w-none text-muted-foreground space-y-4">
            <p>Door een account aan te maken bij Van der Berg Makelaardij krijgt u toegang tot exclusieve functies, waaronder het opslaan van uw favoriete woningen, het instellen van e-mail alerts voor nieuwe aanbiedingen en het beheren van uw bezichtigingsafspraken. Het aanmeldproces is eenvoudig en veilig, en wij respecteren uw privacy.</p>
            <p>Ontdek hoe gemakkelijk het is om uw zoektocht naar een nieuwe woning te stroomlijnen met onze tools. Uw perfecte woning is dichterbij dan u denkt!</p>
          </div>
...
export default function SignupPage() {
  useEffect(() => {
    document.title = 'signup | Van der Berg Makelaardij'
  }, [])
