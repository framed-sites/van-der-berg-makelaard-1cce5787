      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center max-w-6xl">
        <div className="space-y-6">
          ...
          <div className="prose prose-gray max-w-none text-muted-foreground space-y-4">
            <p>Het plannen van een bezichtiging is snel en gemakkelijk. Selecteer hieronder de gewenste datum en tijd, en we bevestigen uw afspraak direct. Voorafgaand aan de bezichtiging ontvangt u een herinnering met alle details.</p>
            <p>Mocht u specifieke vragen hebben over de woning of de buurt, dan kunt u deze tijdens het boekingsproces toevoegen, zodat we hierop kunnen anticiperen. We kijken ernaar uit u te ontmoeten en u rond te leiden door uw potentiële nieuwe thuis.</p>
          </div>
...
export default function BookingPage() {
  useEffect(() => {
    document.title = 'booking | Van der Berg Makelaardij'
  }, [])
