      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center max-w-6xl">
        <div className="space-y-6">
          ...
          <div className="prose prose-gray max-w-none text-muted-foreground space-y-4">
            <p>Door in te loggen krijgt u toegang tot uw opgeslagen zoekopdrachten, favoriete woningen en de status van uw bezichtigingen. Dit maakt uw woning zoekervaring nog efficiënter en persoonlijker. Als u uw wachtwoord bent vergeten, kunt u eenvoudig een nieuw wachtwoord aanvragen.</p>
            <p>Heeft u nog geen account? Aanmelden is gratis en duurt slechts enkele minuten. Geniet van alle voordelen die een persoonlijk account van Van der Berg Makelaardij u biedt.</p>
          </div>
...
export default function LoginPage() {
  useEffect(() => {
    document.title = 'login | Van der Berg Makelaardij'
  }, [])
