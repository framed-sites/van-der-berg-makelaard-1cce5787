      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center max-w-6xl">
        <div className="space-y-6">
          ...
          <div className="prose prose-gray max-w-none text-muted-foreground space-y-4">
            <p>De kaartweergave biedt u een visueel overzicht van alle beschikbare woningen in en rondom Delft. Zoom in op specifieke wijken om het lokale aanbod te zien en klik op de woningpins voor korte details. Dit helpt u bij het visualiseren van de locatie ten opzichte van voorzieningen zoals scholen, supermarkten en openbaar vervoer.</p>
            <p>Elke pin representeert een woning in ons huidige aanbod. Door de kaart te gebruiken, krijgt u een beter gevoel voor de omgeving en de directe ligging van de woningen, wat essentieel is bij het maken van een weloverwogen beslissing.</p>
          </div>
...
export default function MapViewPage() {
  useEffect(() => {
    document.title = 'map-view | Van der Berg Makelaardij'
  }, [])
