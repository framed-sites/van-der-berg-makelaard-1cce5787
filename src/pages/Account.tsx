      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center max-w-6xl">
        <div className="space-y-6">
          ...
          <div className="prose prose-gray max-w-none text-muted-foreground space-y-4">
            <p>Hier kunt u al uw relevante informatie beheren: uw persoonlijke gegevens, opgeslagen zoekopdrachten, favoriete woningen, en de status van uw geplande bezichtigingen. Houd uw profiel up-to-date om de meest relevante woningaanbiedingen te ontvangen.</p>
            <p>We streven ernaar om u de best mogelijke ervaring te bieden, en dit dashboard is ontworpen om u volledige controle te geven over uw woningzoektocht. Mocht u vragen of wensen hebben, neem dan gerust contact met ons op.</p>
          </div>
...
export default function AccountPage() {
  useEffect(() => {
    document.title = 'account | Van der Berg Makelaardij'
  }, [])
