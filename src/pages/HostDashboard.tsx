      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center max-w-6xl">
        <div className="space-y-6">
          ...
          <div className="prose prose-gray max-w-none text-muted-foreground space-y-4">
            <p>Als verkoper bij Van der Berg Makelaardij heeft u via dit dashboard volledig inzicht in de status van uw woningverkoop. Bekijk het aantal bezichtigingsaanvragen, de feedback van potentiële kopers, marketingactiviteiten en belangrijke documenten. We houden u continu op de hoogte van de voortgang.</p>
            <p>Ons doel is transparantie en efficiëntie. Dit dashboard is ontworpen om u gemoedsrust te geven en u te betrekken bij elke fase van het verkoopproces. Wij streven naar de best mogelijke verkoopresultaten voor u.</p>
          </div>
...
export default function HostDashboardPage() {
  useEffect(() => {
    document.title = 'host-dashboard | Van der Berg Makelaardij'
  }, [])
